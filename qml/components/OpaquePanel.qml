...
SilicaFlickable {
    ...
    MouseArea {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                GradientStop { position: 0.0; color: Theme.rgba(Theme.secondaryHighlightColor, 0.85) }
                GradientStop { position: 1.0; color: Theme.rgba(Theme.secondaryHighlightColor, 1) }
            }
